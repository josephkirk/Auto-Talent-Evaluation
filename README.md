...
Managing employee evaluations can be a slog. You've got accomplishments to track, peer observations to collect, and then you actually have to write thoughtful performance reviews. This app is meant to make that whole process a bit easier.

The idea is straightforward:
1. Add your team members and track their key accomplishments
2. Collect peer observations and feedback
3. Generate professional performance review summaries using AI (via Ollama)
...
- **Dashboard** — See all your employees at a glance with stats on accomplishments and observations
- **Employee Details** — Dive into a specific person's accomplishments, observations, and add new entries
